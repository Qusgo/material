...
installWorldState(createWorldState(cols,rows,{cellSize,viewW,viewH,bodies,nextBodyId,airColor,simTick,editDirty,runtimeSettings:{sourceInterval,lightingEnabled,lightStrength,sideLightStrength,shadowStrength}}));
function syncRuntimeSettingsToGlobals(settings={}){
